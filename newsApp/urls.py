...
from .views import news_list, news_detail, HomePageView, ContactPageView, aboutPageView, LocalNewsView, ForeignNewsView, \
    TechnologyNewsView, SportNewsView, NewsUpdateView, NewsDeleteView, NewsCreateView, admin_page_view, SearchResultsList
