...
class HomePageView(ListView):
    ...
    def get_context_data(self, *, object_list=None, **kwargs):
        ...
        context['maxalliy_xabarlar'] = News.published.all().filter(category__name="Mahalliy").order_by("-publish_time")[
                                       :6]
        ...
        context['texnologiya_xabarlari'] = News.published.all().filter(category__name="Texnologiya").order_by(
            "-publish_time")[:6]
        return context
